...
" f is for 'fuzzy find'
nnoremap <silent> <leader>ff <cmd>lua telescope_project_files()<cr>
let g:which_key_map.f = {
  ...
  \ 'd' : [':Telescope lsp_workspace_diagnostics', 'diagnostic workspace'],
  \ 'D' : [':Telescope lsp_document_diagnostics' , 'diagnostic buffer'],
  \ 'f' :                                          'files',
  \ 'g' : [':Telescope live_grep'                , 'grep search'],
  \ 'h' : [':Telescope help_tags'                , 'help tags'],
  \ 'H' : [':Telescope highlights'               , 'highlight groups'],
  \ 'j' : [':Telescope jumplist'                 , 'jumplist'],
  \ 'n' : [':TodoTelescope'                      , 'notes'],
  \ 'o' : [':Telescope oldfiles'                 , 'old files'],
  \ 'O' : [':Telescope vim_options'              , 'options'],
  \ 'r' : [':Telescope lsp_references'           , 'references (LSP)'],
  \ 's' : [':Telescope spell_suggest'            , 'spell suggestions'],
  \ 'S' : [':Telescope treesitter'               , 'symbols (treesitter)'],
  \ 't' : [':Telescope file_browser'             , 'file browser'],
  \ }
