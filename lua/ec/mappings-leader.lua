...
nmap_leader('fb', [[<Cmd>Telescope buffers<CR>]],                   'Open buffers')
...
nmap_leader('fd', [[<Cmd>Telescope diagnostics<CR>]],               'Diagnostic workspace')
nmap_leader('fD', [[<Cmd>Telescope diagnostics bufnr=0<CR>]],       'Diagnostic buffer')
nmap_leader('ff', [[<Cmd>lua EC.telescope_project_files()<cr>]],    'Files')
nmap_leader('fg', [[<Cmd>Telescope live_grep<CR>]],                 'Grep search')
...
nmap_leader('fn', [[<Cmd>TodoTelescope<CR>]],                       'Notes')
...
nmap_leader('oh', [[<Cmd>lua EC.move_arg('left')<CR>]],      'Move arg left')
...
nmap_leader('ol', [[<Cmd>lua EC.move_arg('right')<CR>]],     'Move arg right')
