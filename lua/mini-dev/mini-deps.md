...
To install from standalone repository, replace any occurrence of 'mini.nvim' to 'mini.deps'.

## Overview

See [example 'init.lua' file](../scripts/init-deps-example.lua) for a quick look at how 'mini.deps' can be used.
