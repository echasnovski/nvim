...
T['_parse()']['can resolve special variables'] = function()
  ...
  local ref_random = { { text = '491985' }, { text = '873024' }, { text = '10347d' }, { text = 'df5ed0' } }
  validate( '${RANDOM}${RANDOM}${RANDOM_HEX}${RANDOM_HEX}', ref_random)

  -- - Should prefer user lookup
  eq(parse('$TM_SELECTED_TEXT', { resolve_vars = { TM_SELECTED_TEXT = 'xxx' } }), { { text = 'xxx' } })
  eq(
    parse('${RANDOM}${RANDOM}${RANDOM_HEX}${RANDOM_HEX}', { resolve_vars = { RANDOM = 'a', RANDOM_HEX = 'b' } }),
