...
function MiniBase16.apply(palette, name)
  ...
  H.hi('ColorColumn',  {guifg=nil,      guibg=p.base01, gui='none',      guisp=nil})
  H.hi('Conceal',      {guifg=p.base0D, guibg=p.base00, gui=nil,         guisp=nil})
  H.hi('Cursor',       {guifg=p.base00, guibg=p.base05, gui=nil,         guisp=nil})
  H.hi('CursorColumn', {guifg=nil,      guibg=p.base01, gui='none',      guisp=nil})
  H.hi('CursorIM',     {guifg=p.base00, guibg=p.base05, gui=nil,         guisp=nil})
  H.hi('CursorLine',   {guifg=nil,      guibg=p.base01, gui='none',      guisp=nil})
  ...
  H.hi('IncSearch',    {guifg=p.base01, guibg=p.base09, gui='none',      guisp=nil})
  ...
  H.hi('MsgSeparator', {guifg=p.base04, guibg=p.base02, gui='none',      guisp=nil})
  H.hi('NonText',      {guifg=p.base03, guibg=nil,      gui=nil,         guisp=nil})
  H.hi('Normal',       {guifg=p.base05, guibg=p.base00, gui=nil,         guisp=nil})
  H.hi('NormalFloat',  {guifg=p.base05, guibg=p.base01, gui='none',      guisp=nil})
  H.hi('NormalNC',     {guifg=p.base05, guibg=p.base00, gui=nil,         guisp=nil})
  H.hi('PMenu',        {guifg=p.base05, guibg=p.base01, gui='none',      guisp=nil})
  H.hi('PMenuSbar',    {guifg=nil,      guibg=p.base02, gui='none',      guisp=nil})
  H.hi('PMenuSel',     {guifg=p.base01, guibg=p.base05, gui=nil,         guisp=nil})
  H.hi('PMenuThumb',   {guifg=nil,      guibg=p.base07, gui='none',      guisp=nil})
  H.hi('Question',     {guifg=p.base0D, guibg=nil,      gui=nil,         guisp=nil})
  H.hi('QuickFixLine', {guifg=nil,      guibg=p.base01, gui='none',      guisp=nil})
  ...
  H.hi('StatusLine',   {guifg=p.base04, guibg=p.base02, gui='none',      guisp=nil})
  H.hi('StatusLineNC', {guifg=p.base03, guibg=p.base01, gui='none',      guisp=nil})
  H.hi('Substitute',   {guifg=p.base01, guibg=p.base0A, gui='none',      guisp=nil})
  H.hi('TabLine',      {guifg=p.base03, guibg=p.base01, gui='none',      guisp=nil})
  H.hi('TabLineFill',  {guifg=p.base03, guibg=p.base01, gui='none',      guisp=nil})
  H.hi('TabLineSel',   {guifg=p.base0B, guibg=p.base01, gui='none',      guisp=nil})
  H.hi('TermCursor',   {guifg=nil,      guibg=nil,      gui='reverse',   guisp=nil})
  H.hi('TermCursorNC', {guifg=nil,      guibg=nil,      gui='reverse',   guisp=nil})
  H.hi('Title',        {guifg=p.base0D, guibg=nil,      gui='none',      guisp=nil})
  H.hi('VertSplit',    {guifg=p.base02, guibg=p.base02, gui='none',      guisp=nil})
  ...
  H.hi('Italic',     {guifg=nil,      guibg=nil, gui='none', guisp=nil})
